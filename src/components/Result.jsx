      ...
      <div className="flex justify-center items-center">
        <div className="text-center py-2 w-3/5 rounded p-6 pb-10 bg-[#416165] overflow-scroll">
          <div className="grid grid-cols-2 gap-2">
            <div className="col-span-1 text-xs sm:text-xl text-[#D0CDD7]">
              Domain : {data.domain}
            </div>
          ...
          {data.result.length === 0 && (
            <div className="col-span-1 text-[#D0CDD7] p-4 text-center py-2 border px-2 truncate text-md my-1 rounded bg-[#0B3948] hover:bg-[#416165] hover:border-[#0B3948]">
              {"No Result Found"}
            </div>
          )}
